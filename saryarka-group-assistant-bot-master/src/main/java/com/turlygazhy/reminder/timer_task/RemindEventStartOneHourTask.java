 ...
 */
public class RemindEventStartOneHourTask extends AbstractTask {
    private long eventId;
    public RemindEventStartOneHourTask(Bot bot, Reminder reminder, long eventId) {
        super(bot, reminder);
    ...
    public void run() {
        try {
            answerAllMembersAboutHour();
        } catch (SQLException | TelegramApiException e) {
            e.printStackTrace();
        }

    }
    private void answerAllMembersAboutHour() throws SQLException, TelegramApiException {
